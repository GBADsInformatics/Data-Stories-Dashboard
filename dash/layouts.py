...
page_1 = html.Div([
    html.Div([
        ...
        html.Div([html.H1('Data Stories Dashboard', className="header-title")], className="header-title-div"),
                                    ...
                                    children=[
                                        html.Div(
                                            ...
                                            children=[
                                                ...
                                                dcc.Dropdown(
                                                    id='animal-dropdown',
                                                    options=['Cattle', 'Poultry', 'Sheep'],
                                                    value='Cattle',
                                                    clearable=False,
                                                ),
                                                html.H5("Table",style={"margin":"0.4rem 0 0.2rem 0"}),
                                                dcc.Dropdown(
                                                    id='table-dropdown',
